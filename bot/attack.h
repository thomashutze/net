...
void attack_method_hotspot(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_r6(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_method_fortnite(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
